...
public class AllocationoneWindow extends JFrame {
	...
	public AllocationoneWindow(){
		...
		*/
		...
		btn_1=new JButton("高级查询");btn_2=new JButton("增加单据");btn_3=new JButton("修改单据");
		btn_4=new JButton("删除单据");btn_6=new JButton("确定");
		...
		//top第一个表格
				...
				columnNames1.add("供货商");
				columnNames1.add("调入仓库");
				columnNames1.add("应付金额");
				columnNames1.add("实付金额");
