...
public class AddAllocation  extends JDialog{
	...
	public  AddAllocation  (){
		...
		//top层
		jp_top.setBorder(BorderFactory.createTitledBorder("查询商品列表"));
		...
		jp_top2.add(tf3);
		jp_top.add(jp_top2);		
		jp_top3.add(new JLabel("提示：输入商品编号或名称查询商品查询到商品后添加到右边所选商品"));
		jp_top.add(jp_top3);
				
		jp_center_left.setBorder(BorderFactory.createTitledBorder("商品清单"));
		jp_center_right.setBorder(BorderFactory.createTitledBorder("所选商品"));
